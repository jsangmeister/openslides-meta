...
-- MODELS_YML_CHECKSUM = '4965e682383824bec80f9e7a6c97d5d5'
-- Type definitions
DO $$
BEGIN
...
comment on column motionT.identical_motion_ids is 'Changed from relation-list to number[], because it still can't be generated';
...
(select array_agg(p.id) from projectorT p where p.used_as_default_projector_for_current_los_in_meeting_id = m.id) as default_projector_current_los_ids,
...
-- definition trigger not null for meeting.default_projector_current_los_ids against projectorT.used_as_default_projector_for_current_los_in_meeting_id
CREATE CONSTRAINT TRIGGER tr_i_meeting_default_projector_current_los_ids AFTER INSERT ON projectorT INITIALLY DEFERRED
...
CREATE CONSTRAINT TRIGGER tr_ud_meeting_default_projector_current_los_ids AFTER UPDATE OF used_as_default_projector_for_current_los_in_meeting_id OR DELETE ON projectorT
FOR EACH ROW EXECUTE FUNCTION check_not_null_for_relation_lists('meeting', 'default_projector_current_los_ids', 'used_as_default_projector_for_current_los_in_meeting_id');
...
/*
SQL nts+:1tR => organization/committee_ids:-> committee/organization_id
...
SQL nrt:1tR => organization/organization_tag_ids:-> organization_tag/organization_id
FIELD 1rtR:1t => organization/theme_id:-> theme/theme_for_organization_id
SQL nrt:1tR => organization/theme_ids:-> theme/organization_id
SQL nt:1GtR => organization/mediafile_ids:-> mediafile/owner_id
SQL nrt:1tR => organization/user_ids:-> user/organization_id
...
FIELD 1tR:nrt => user/organization_id:-> organization/user_ids
...
FIELD 1tR:nrt => organization_tag/organization_id:-> organization/organization_tag_ids

SQL 1t:1rtR => theme/theme_for_organization_id:-> organization/theme_id
FIELD 1tR:nrt => theme/organization_id:-> organization/theme_ids

SQL nt:1tR => committee/meeting_ids:-> meeting/committee_id
FIELD 1rt:1t => committee/default_meeting_id:-> meeting/default_meeting_for_committee_id
...
FIELD 1tR:nts+ => committee/organization_id:-> organization/committee_ids
...
FIELD 1rt:1t => meeting/logo_projector_main_id:-> mediafile/used_as_logo_projector_main_in_meeting_id
FIELD 1rt:1t => meeting/logo_projector_header_id:-> mediafile/used_as_logo_projector_header_in_meeting_id
FIELD 1rt:1t => meeting/logo_web_header_id:-> mediafile/used_as_logo_web_header_in_meeting_id
FIELD 1rt:1t => meeting/logo_pdf_header_l_id:-> mediafile/used_as_logo_pdf_header_l_in_meeting_id
FIELD 1rt:1t => meeting/logo_pdf_header_r_id:-> mediafile/used_as_logo_pdf_header_r_in_meeting_id
FIELD 1rt:1t => meeting/logo_pdf_footer_l_id:-> mediafile/used_as_logo_pdf_header_l_in_meeting_id
FIELD 1rt:1t => meeting/logo_pdf_footer_r_id:-> mediafile/used_as_logo_pdf_header_l_in_meeting_id
FIELD 1rt:1t => meeting/logo_pdf_ballot_paper_id:-> mediafile/used_as_logo_pdf_ballot_paper_in_meeting_id
FIELD 1rt:1t => meeting/font_regular_id:-> mediafile/used_as_font_regular_in_meeting_id
FIELD 1rt:1t => meeting/font_italic_id:-> mediafile/used_as_font_italic_in_meeting_id
FIELD 1rt:1t => meeting/font_bold_id:-> mediafile/used_as_font_bold_in_meeting_id
FIELD 1rt:1t => meeting/font_bold_italic_id:-> mediafile/used_as_font_bold_italic_in_meeting_id
FIELD 1rt:1t => meeting/font_monospace_id:-> mediafile/used_as_font_monospace_in_meeting_id
FIELD 1rt:1t => meeting/font_chyron_speaker_name_id:-> mediafile/used_as_font_chyron_speaker_name_in_meeting_id
FIELD 1rt:1t => meeting/font_projector_h1_id:-> mediafile/used_as_font_projector_h1_in_meeting_id
FIELD 1rt:1t => meeting/font_projector_h2_id:-> mediafile/used_as_font_projector_h2_in_meeting_id
FIELD 1tR:nt => meeting/committee_id:-> committee/meeting_ids
SQL 1t:1rt => meeting/default_meeting_for_committee_id:-> committee/default_meeting_id
...
FIELD 1rt:1t => meeting/list_of_speakers_countdown_id:-> projector_countdown/used_as_list_of_speakers_countdown_meeting_id
FIELD 1rt:1t => meeting/poll_countdown_id:-> projector_countdown/used_as_poll_countdown_meeting_id
...
SQL ntR:1t => meeting/default_projector_current_los_ids:-> projector/used_as_default_projector_for_current_los_in_meeting_id
...
FIELD 1rt:1t => meeting/admin_group_id:-> group/admin_group_for_meeting_id
...
SQL 1t:1rt => group/admin_group_for_meeting_id:-> meeting/admin_group_id
...
FIELD 1rt:1t => poll/global_option_id:-> option/used_as_global_option_in_poll_id
...
SQL 1t:1rt => option/used_as_global_option_in_poll_id:-> poll/global_option_id
...
SQL 1t:1rt => mediafile/used_as_logo_projector_main_in_meeting_id:-> meeting/logo_projector_main_id
SQL 1t:1rt => mediafile/used_as_logo_projector_header_in_meeting_id:-> meeting/logo_projector_header_id
SQL 1t:1rt => mediafile/used_as_logo_web_header_in_meeting_id:-> meeting/logo_web_header_id
SQL 1t:1rt => mediafile/used_as_logo_pdf_header_l_in_meeting_id:-> meeting/logo_pdf_header_l_id
SQL 1t:1rt => mediafile/used_as_logo_pdf_header_r_in_meeting_id:-> meeting/logo_pdf_header_r_id
SQL 1t:1rt => mediafile/used_as_logo_pdf_footer_l_in_meeting_id:-> meeting/logo_pdf_footer_l_id
SQL 1t:1rt => mediafile/used_as_logo_pdf_footer_r_in_meeting_id:-> meeting/logo_pdf_footer_r_id
SQL 1t:1rt => mediafile/used_as_logo_pdf_ballot_paper_in_meeting_id:-> meeting/logo_pdf_ballot_paper_id
SQL 1t:1rt => mediafile/used_as_font_regular_in_meeting_id:-> meeting/font_regular_id
SQL 1t:1rt => mediafile/used_as_font_italic_in_meeting_id:-> meeting/font_italic_id
SQL 1t:1rt => mediafile/used_as_font_bold_in_meeting_id:-> meeting/font_bold_id
SQL 1t:1rt => mediafile/used_as_font_bold_italic_in_meeting_id:-> meeting/font_bold_italic_id
SQL 1t:1rt => mediafile/used_as_font_monospace_in_meeting_id:-> meeting/font_monospace_id
SQL 1t:1rt => mediafile/used_as_font_chyron_speaker_name_in_meeting_id:-> meeting/font_chyron_speaker_name_id
SQL 1t:1rt => mediafile/used_as_font_projector_h1_in_meeting_id:-> meeting/font_projector_h1_id
SQL 1t:1rt => mediafile/used_as_font_projector_h2_in_meeting_id:-> meeting/font_projector_h2_id
...
FIELD 1t:ntR => projector/used_as_default_projector_for_current_los_in_meeting_id:-> meeting/default_projector_current_los_ids
...
SQL 1t:1rt => projector_countdown/used_as_list_of_speakers_countdown_meeting_id:-> meeting/list_of_speakers_countdown_id
SQL 1t:1rt => projector_countdown/used_as_poll_countdown_meeting_id:-> meeting/poll_countdown_id
